    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center animate-fade-in">
            <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl max-w-2xl w-full border border-slate-700">
                <h1 className="text-4xl md:text-5xl font-bold text-cyan-400 mb-2">{t('practice.title')}</h1>
                <p className="text-slate-400 mb-8">{t('practice.subtitle')}</p>
